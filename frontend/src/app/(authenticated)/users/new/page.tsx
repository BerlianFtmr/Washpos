...
export default function CreateUserPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showError('Gagal menambahkan pengguna. Username mungkin sudah digunakan.');
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <div className="max-w-2xl mx-auto mt-4">
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
          <div className="p-5 border-b border-slate-200 bg-slate-50/50">
            <h1 className="text-xl font-bold text-slate-800">Tambah Pengguna Baru</h1>
            <p className="text-sm text-slate-500 mt-1">
              Lengkapi form di bawah ini untuk membuat akun akses ke dalam sistem Washpos.
            </p>
          </div>
