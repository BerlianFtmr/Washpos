...
export default function CreateServicePage() {
  ...
  return (
    <div>
      <Breadcrumb items={[{ label: 'Layanan', href: '/services' }, { label: 'Tambah Baru' }]} />

      <div className="max-w-2xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-slate-900">Tambah Layanan Baru</h1>
          <p className="text-sm text-slate-500 mt-1">Lengkapi form di bawah ini untuk menambahkan jenis layanan laundry baru.</p>
        </div>
